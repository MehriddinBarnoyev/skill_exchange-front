          ...
          <div className="flex flex-col md:flex-row items-center md:items-end -mt-16 md:-mt-20 mb-4 md:mb-0">
            ...
            {isOwnProfile ? (
              ...
              <div className="space-x-2 ">
                <Button onClick={handleEdit} className="mt-4 md:mt-0 md:ml-auto">
                  Edit Profile
                </Button>
                <Button onClick={() => setShowFriendsModal(true)} variant="outline" className="mt-4 md:mt-0">
          ...
          {isEditing ? (
            <div className="space-y-4 mt-6">
              ...
              <div>
                ...
                />
                {validationErrors.bio && <p className="text-red-500 text-sm mt-1">{validationErrors.bio}</p>}
              </div>
              ...
              <div>
                ...
                {validationErrors.profession && (
                  <p className="text-red-500 text-sm mt-1">{validationErrors.profession}</p>
                )}
              </div>
              ...
              <div>
                <Input
                  ...
                  className={validationErrors.birth_date ? "border-red-500" : ""}
                />
